d3.csv('complete_renewable_energy_dataset.csv').then(data => {
    ...
    const annotations = [
        ...
        { text: "Like any transformational project, investment is required. Though many of these values are in the billions, most of it is spent in R&D. This means that replication of developed technologies is comparatively inexpensive!", position: { top: "-750px", left: "60px"} },
