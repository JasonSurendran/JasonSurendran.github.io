d3.csv('complete_renewable_energy_dataset.csv').then(data => {
    ...
    const annotations = [
        { text: "There are many different forms of renewable energy! Popular examples include wind, solar, and hydro, but there are lesser known examples such as geothermal and biomass. Having a combination of these ensures that a country has a diverse energy portfolio in case one of the energy streams fails.",  position: { top: "-100px", left: "100px" } },
        ...
        { text: "Now its your turn! Use the energy type buttons and slider to filter between countries and their initiatives!", position: { top: "80%", left: "85%" } },
    ];
